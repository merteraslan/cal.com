...
export const LOGO = "/voxvol-logo.png";
export const LOGO_ICON = "/voxvol-logo.png";
export const AVATAR_FALLBACK = "/avatar.svg";
export const FAVICON_16 = "/voxvol-logo-small.png";
export const FAVICON_32 = "/voxvol-logo-small.png";
export const APPLE_TOUCH_ICON = "/voxvol-logo.png";
export const MSTILE_ICON = "/voxvol-logo.png";
export const ANDROID_CHROME_ICON_192 = "/voxvol-logo-small.png";
export const ANDROID_CHROME_ICON_256 = "/voxvol-logo-small.png";
